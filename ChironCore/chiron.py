...
if __name__ == "__main__":
    ...
    if args.bin:
        ...
        # ir = astgen.visitStart(parseTree)
        # if hasattr(astgen, "structs"):
        #     inptr.setStructs(astgen.structs)

        
        # if isinstance(inptr, ConcreteInterpreter):
        #     if hasattr(astgen, "functions"): 
        #         inptr.setFunctions(astgen.functions)
