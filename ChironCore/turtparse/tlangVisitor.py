...
class tlangVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by tlangParser#structInit.
    def visitStructInit(self, ctx:tlangParser.StructInitContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by tlangParser#fieldAccess.
    def visitFieldAccess(self, ctx:tlangParser.FieldAccessContext):
        return self.visitChildren(ctx)
